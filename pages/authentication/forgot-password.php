 ...
 * Implements F103 - Manipulate users (Password Reset functionality)
 * Story 203: Admin resets user password
 */
        ...
        try {
            ...
            if ($user) {
                ...
                <body>
                    <div class='container'>
                        <div class='header'>
                            <h1>Again&Co Password Reset</h1>
                        </div>
                        <div class='content'>
                            <h2>Hello " . htmlspecialchars($user['name']) . ",</h2>
                            <p>We received a request to reset your password for your Again&Co account.</p>
                        ...
                        <div class='footer'>
                            <p>This email was sent from Again&Co<br>
...
$page_title = "Forgot Password - Again&Co";
?>
